...
class KalmanFilter(Filter):
    def predict(self, prev_distribution, transition, control_input_matrix, control_input, noise_covariance):
        ...
        return Distribution(x_k, p_next)

    def update(self, prev_distribution,
        ...
        measurement_predict = measurement_function(x_k)
        ...
        return Distribution(x_updated_k, p_updated_k)
